...
//        OSValidator OSinfo = new OSValidator();
//        System.out.println(OSValidator.getOS());
//    }
    
    OSValidator(){
        System.out.println("System infor: OS is: " + OSValidator.getOS());
    }
    ...
    public static boolean isLinux(){
        return (!isWindow() && !isMac());
    }

    public static String getOS(){
        if(OSValidator.isWindow()){
            return "Windows";
...
//Possible values for system property "os.arch" and "os.name"

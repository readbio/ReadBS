 ...
 * @author Shaojun
 */
public final class PanelSolexaQASEBak extends javax.swing.JPanel {

    private String projectDir = null;
    private ProcessWorkerSin processWorkerMonitor;
     ...
     */
    public PanelSolexaQASEBak(String proDir) throws URISyntaxException, IOException {
        initComponents();
        this.setProjectDir(proDir);
        //System.out.println("PanelSolexaQASE: " + this.getProjectDir() + ". Code in" + this.getClass().getName());
    }

    public PanelSolexaQASEBak() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(534, 418));
        ...
        jPanelDynamicTrimLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelDynamicTrimLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jTextRead, javax.swing.GroupLayout.DEFAULT_SIZE, 445, Short.MAX_VALUE))
            .addGroup(jPanelDynamicTrimLayout.createSequentialGroup()
                .addGap(3, 3, 3)
    ...
    private void jButtonTrimReadsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTrimReadsActionPerformed
        ...
        try {
            ...
            Logger.getLogger(PanelSolexaQASEBak.class.getName()).log(Level.SEVERE, null, ex);
        }
        ArrayList<String[]> commandLines = null;
        try {
            commandLines = solexaQACMD.getSolexaCMD(jTextRead.getText(),
                    jTxtSampleName.getText(),jTxtProbCutCutoff.getText(), jTxtLengthCutoff.getText());
        } catch (IOException ex) {
            Logger.getLogger(PanelSolexaQASEBak.class.getName()).log(Level.SEVERE, null, ex);
